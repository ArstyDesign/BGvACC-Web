    ...
    (d.animateFlakes = function (b) {
      ...
      b.each(function () {
        ...
        var i = a(this),
                j = 10 * c(0, 100) - 1e3;
        d++;
        var k = {left: c(0, 100) + "%", top: j + "px", width: c(0, 5) + "px", height: c(0, 5) + "px", transform: "rotate" + (c(0, 100) + "deg")};
        i.css(k),
          ...
          (a.letItSnow.defaultOptions = {stickyFlakes: "lis-flake--js", makeFlakes: !0, sticky: !0}),
