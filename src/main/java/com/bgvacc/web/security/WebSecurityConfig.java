...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.csrf().disable()
            ...
            .antMatchers("/atc-reservations/create", "/atc-reservations/search-trainee/**").hasAnyRole("ATC_S1", "ATC_S2", "ATC_S3", "ATC_C1", "ATC_S3", "ATC_I1", "ATC_I3")
            .antMatchers("/atc-reservations/**").permitAll()
